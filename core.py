...
def get_stock_list() -> pd.DataFrame:
    ...
    def _fallback_builtin():
        ...
        builtin_data = [
            ...
            ("000768", "中航西飞"), ("000858", "五粮液"), ("000895", "双汇发展"),
            ("002001", "新和成"), ("002007", "华兰生物"), ("002024", "苏宁易购"),
            ("002027", "分众传媒"), ("002049", "紫光国微"), ("002120", "韵达股份"),
            ("002142", "宁波银行"), ("002230", "科大讯飞"), ("002236", "大华股份"),
            ("002271", "东方雨虹"), ("002352", "顺丰控股"), ("002415", "海康威视"),
            ("002460", "赣锋锂业"), ("002475", "立讯精密"), ("002594", "比亚迪"),
            ("002714", "牧原股份"), ("002812", "恩捷股份"), ("002821", "凯莱英"),
            ("300003", "乐普医疗"), ("300014", "亿纬锂能"), ("300015", "爱尔眼科"),
            ("300033", "同花顺"), ("300059", "东方财富"), ("300122", "智飞生物"),
            ("300124", "汇川技术"), ("300142", "沃森生物"), ("300274", "阳光电源"),
            ("300408", "三环集团"), ("300413", "芒果超媒"), ("300433", "蓝思科技"),
            ("300496", "中科创达"), ("300529", "健帆生物"), ("300760", "迈瑞医疗"),
            ("300832", "新产业"), ("300999", "金龙鱼"), ("600000", "浦发银行"),
            ...
            ("600588", "用友网络"), ("600690", "海尔智家"), ("600745", "闻泰科技"),
            ("600809", "山西汾酒"), ("600837", "海通证券"), ("600887", "伊利股份"),
            ("600900", "长江电力"), ("601012", "隆基绿能"), ("601066", "中信建投"),
            ("601088", "中国神华"), ("601166", "兴业银行"), ("601211", "国泰君安"),
            ("601288", "农业银行"), ("601318", "中国平安"), ("601398", "工商银行"),
            ("601601", "中国太保"), ("601628", "中国人寿"), ("601668", "中国建筑"),
            ("601688", "华泰证券"), ("601888", "中国中免"), ("601899", "紫金矿业"),
            ("601933", "永辉超市"), ("603288", "海天味业"), ("603501", "韦尔股份"),
            ("603659", "璞泰来"), ("603799", "华友钴业"), ("603986", "兆易创新"),
            ("603993", "洛阳钼业"), ("688001", "华兴源创"), ("688008", "澜起科技"),
            ("688012", "中微公司"), ("688036", "传音控股"), ("688111", "金山办公"),
